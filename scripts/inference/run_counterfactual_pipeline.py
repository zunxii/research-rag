"""
Full pipeline with Gemini - EXACT original logic
"""
...
def main():
    ...
    # ---------------- Layer 2: Diagnostic Scoring (original) ----------------
    ...
    # ---------------- Layer 3: Gemini Explanation (original) ----------------
