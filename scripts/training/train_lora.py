"""
LoRA training script - EXACT original logic
...
# Import from config (relative path from root)
import sys
...
ACCUM_STEPS = LORA_CONFIG["accum_steps"]
...
# -------------------------
# CLIP Contrastive Loss (original)
# -------------------------
